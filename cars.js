  ...
  fetch("json/csvjson.json")
      ...
      .then(response => {
        for(let i = 74; i <= 429; i++) {
          ...
          tab.document.write("<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><meta http-equiv='X-UA-Compatible' content='IE=edge'><meta name='viewport' content='width=device-width, initial-scale=1.0'><link rel='stylesheet' href='css/bootstrap.min.css'><link rel='stylesheet' href='carprofile/carprofile.css'><link rel='icon' href='https://i.redd.it/6o3morbndos81.png'><link rel='stylesheet' href='https://use.fontawesome.com/releases/v6.1.1/css/all.css'><script src='https://kit.fontawesome.com/6dd17b7bf7.js' crossorigin='anonymous'></script><title>FH5 Web</title></head><body><div class='topnav' id='myTopnav'></div><div class='loadwind' id='loader'></div><a class='agoback' href='cars.html'>← Go Back</a><div class='container-fluid'><div class='row'><div class='headerdivver col-lg-12'><p class='name'>" + response[i - 74].Name_and_model + "</p></div></div><div class='row'><div class='leftdivver col-lg-3'></div><div class='imgdivver col-lg-6'><img id='img' class='bigimg' src='img/All/" + i + ".jpg'></div><div class='rightdivver col-lg-3'></div></div><div class='row'><div class='bottomdivver col-lg-12'></div></div></div><p class='model'>" + response[i - 74].Model_type + "</p><div class='bg'></div><p class='cr'>CR</p><p class='price'>" + response[i - 74].In_Game_Price + "</p><p class='source'>" + response[i - 74].car_source + "</p><p class='specs'>" + response[i - 74].stock_specs + "</p><p class='rating'>" + response[i - 74].Stock_Rating + "</p><p class='drivetype'>" + response[i - 74].Drive_Type + "</p><p class='speed'>" + response[i - 74].speed + "</p><p class='handling'>" + response[i - 74].handling + "</p><p class='acceleration'>" + response[i - 74].acceleration + "</p><p class='launch'>" + response[i - 74].launch + "</p><p class='braking'>" + response[i - 74].braking + "</p><p class='offroad'>" + response[i - 74].Offroad + "</p><p class='hp'>" + response[i - 74].Horse_Power + " HP" + "</p><p class='weight'>" + response[i - 74].Weight_lbs + " Lbs<footer></footer></body><script src='js/bootstrap.min.js'><script src='carprofile/carprofile.js'></script></html>");
          tab.document.close();});
        ...
        for(let i = 450; i < 629; i++) {
          ...
          el3.addEventListener("click", function() {var tab = window.open("Cars", "_self");
          tab.document.write("<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><meta http-equiv='X-UA-Compatible' content='IE=edge'><meta name='viewport' content='width=device-width, initial-scale=1.0'><link rel='stylesheet' href='css/bootstrap.min.css'><link rel='stylesheet' href='carprofile/carprofile.css'><link rel='icon' href='https://i.redd.it/6o3morbndos81.png'><link rel='stylesheet' href='https://use.fontawesome.com/releases/v6.1.1/css/all.css'><script src='https://kit.fontawesome.com/6dd17b7bf7.js' crossorigin='anonymous'></script><title>FH5 Web</title></head><body><div class='topnav' id='myTopnav'></div><div class='loadwind' id='loader'></div><a class='agoback' href='cars.html'>← Go Back</a><div class='container-fluid'><div class='row'><div class='headerdivver col-lg-12'><p class='name'>" + response[i - 74].Name_and_model + "</p></div></div><div class='row'><div class='leftdivver col-lg-3'></div><div class='imgdivver col-lg-6'><img id='img' class='bigimg' src='img/All/" + i + ".jpg'></div><div class='rightdivver col-lg-3'></div></div><div class='row'><div class='bottomdivver col-lg-12'></div></div></div><p class='model'>" + response[i - 94].Model_type + "</p><div class='bg'></div><p class='cr'>CR</p><p class='price'>" + response[i - 94].In_Game_Price + "</p><p class='source'>" + response[i - 94].car_source + "</p><p class='specs'>" + response[i - 94].stock_specs + "</p><p class='rating'>" + response[i - 94].Stock_Rating + "</p><p class='drivetype'>" + response[i - 94].Drive_Type + "</p><p class='speed'>" + response[i - 94].speed + "</p><p class='handling'>" + response[i - 94].handling + "</p><p class='acceleration'>" + response[i - 94].acceleration + "</p><p class='launch'>" + response[i - 94].launch + "</p><p class='braking'>" + response[i - 94].braking + "</p><p class='offroad'>" + response[i - 94].Offroad + "</p><p class='hp'>" + response[i - 94].Horse_Power + " HP" + "</p><p class='weight'>" + response[i - 94].Weight_lbs + " Lbs<footer></footer></body><script src='js/bootstrap.min.js'><script src='carprofile/carprofile.js'></script></html>");
          tab.document.close();});
          select.appendChild(el3)
        }
      })
