  ...
  fetch("json/csvjson.json")
      ...
      .then(response => {
        ...
        for(let i = 450; i < 629; i++) {
          ...
          el3.addEventListener("click", function() {var tab = window.open("Cars", "_self");
          tab.document.write("<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><meta http-equiv='X-UA-Compatible' content='IE=edge'><meta name='viewport' content='width=device-width, initial-scale=1.0'><link rel='stylesheet' href='css/bootstrap.min.css'><link rel='stylesheet' href='carprofile/carprofile.css'><link rel='icon' href='https://i.redd.it/6o3morbndos81.png'><link rel='stylesheet' href='https://use.fontawesome.com/releases/v6.1.1/css/all.css'><title>FH5 Web</title></head><body><div class='topnav' id='myTopnav'></div><div class='loadwind' id='loader'></div><a class='agoback' href='cars.html'>← Go Back</a><div class='container-fluid'><div class='row'><div class='headerdivver col-lg-12'><p id='name' class='name'>" + response[i - 94].Name_and_model + "</p></div></div><div class='row'><div class='leftdivver col-lg-3'><div class='infocontainer'></div></div><div class='imgdivver col-lg-6'><img id='img' class='bigimg' src='img/All/" + i + ".jpg'></div><div class='rightdivver col-lg-3'><div class='slidecontainer'><div class='row'><div class='col-12 specers'>Specs</div><div class='namer col-6'>Speed</div><div class='statr col-6'>" + response[i - 74].speed + "</div><input type='range' min='0' value='50'   max='100' class='slider' id='speedslider'><div class='namer col-6'>Handling</div><div class='statr col-6'>" + response[i - 74].handling + "</div><input type='range' min='0' value='50'   max='100' class='slider' id='handlingslider'><div class='namer col-6'>Acceleration</div><div class='statr col-6'>" + response[i - 74].acceleration + "</div><input type='range' min='0' value='50'   max='100' class='slider' id='accelerationslider'><div class='namer col-6'>Launch</div><div class='statr col-6'>" + response[i - 74].launch + "</div><input type='range' min='0' value='50'   max='100' class='slider' id='launchslider'><div class='namer col-6'>Braking</div><div class='statr col-6'>" + response[i - 74].braking + "</div><input type='range' min='0' value='50'   max='100' class='slider' id='brakingslider'><div class='namer col-6'>Offroad</div><div class='statr col-6'>" + response[i - 74].Offroad + "</div><input type='range' min='0' value='50'   max='100' class='slider' id='offroadslider'></div></div><div class='row'><div class='bottomdivver col-lg-12'></div></div></div><footer></footer></body><script src='js/bootstrap.min.js'><\/script><script src='carprofile/carprofile.js'><\/script></html>");
          tab.document.close();});
          select.appendChild(el3)
        }
      })
